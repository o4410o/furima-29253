...
RSpec.describe User, type: :model do
  ...
  describe "ユーザー新規登録" do
    context "新規登録がうまくいくとき" do
      ...
      it "passwordが６文字以上で英数字混同であれば登録できる" do
    ...
    context "新規登録がうまくいかないとき" do
      ...
      it "パスワードが半角英数字の混合になっていないなら登録できない"do
